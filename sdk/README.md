# PSSqlRepository Extensions SDK (0.6.0)
...
- `PSSqlRepository.Abstractions.0.6.0.nupkg`
- `PSSqlRepository.Authentications.0.6.0.nupkg`
- `PSSqlRepository.Core.0.6.0.nupkg`
- `PSSqlRepository.Extensions.Sdk.0.6.0.nupkg`
- `PSSqlRepository.Providers.0.6.0.nupkg`
...
3. Reference the SDK from your extension project:
   ...
   ```sh
   dotnet add package PSSqlRepository.Extensions.Sdk --version 0.6.0
   ```
