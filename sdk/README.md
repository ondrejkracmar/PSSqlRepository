# PSSqlRepository Extensions SDK (0.0.1)
...
- `PSSqlRepository.Abstractions.0.0.1.nupkg`
- `PSSqlRepository.Authentications.0.0.1.nupkg`
- `PSSqlRepository.Core.0.0.1.nupkg`
- `PSSqlRepository.Extensions.Sdk.0.0.1.nupkg`
- `PSSqlRepository.Providers.0.0.1.nupkg`
...
3. Reference the SDK from your extension project:
   ...
   ```sh
   dotnet add package PSSqlRepository.Extensions.Sdk --version 0.0.1
   ```
